...
export const SelectedChannelStore: any = findStoreLazy("SelectedChannelStore");
export const UserSettingsProtoStore: any = findStoreLazy("UserSettingsProtoStore");
export const AuthenticationStore: any = findStoreLazy("AuthenticationStore");
